...
public class MixtureAndAlligation_Main extends AppCompatActivity {
    CardView CardView1,CardView2,CardView3,CardView4,CardView5,CardView6,cardView7;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mixture_and_alligation__main);

        CardView topic1 = (CardView) findViewById(R.id.card1);
        topic1.setOnClickListener(navigateTo(MixtureAndAlligation_Explanation.class));
    ...
    public View.OnClickListener navigateTo(final Class<?> clazz) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MixtureAndAlligation_Main.this, clazz);
