...
public class RacesAndGamesOfSkill_Main extends AppCompatActivity {
    CardView CardView1,CardView2,CardView3,CardView4,CardView5,CardView6;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_races_and_games_of_skill__main);
    ...
    public View.OnClickListener navigateTo(final Class<?> clazz) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RacesAndGamesOfSkill_Main.this, clazz);
